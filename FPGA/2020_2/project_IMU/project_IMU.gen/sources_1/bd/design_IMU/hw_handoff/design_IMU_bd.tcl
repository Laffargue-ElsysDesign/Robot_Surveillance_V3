...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net I2C_master_0_ack_err [get_bd_pins I2C_master_0/ack_err] [get_bd_pins IMU_control_0/ack_err_i2c] [get_bd_pins ila_0/probe6]
  connect_bd_net -net I2C_master_0_busy [get_bd_pins I2C_master_0/busy] [get_bd_pins IMU_control_0/busy_i2c]
  connect_bd_net -net I2C_master_0_data_rd [get_bd_pins I2C_master_0/data_rd] [get_bd_pins IMU_control_0/data_ri2c] [get_bd_pins ila_0/probe5]
  ...
  connect_bd_net -net IMU_control_0_addr_i2c [get_bd_pins I2C_master_0/addr] [get_bd_pins IMU_control_0/addr_i2c] [get_bd_pins ila_0/probe3]
  connect_bd_net -net IMU_control_0_data_wi2c [get_bd_pins I2C_master_0/data_wr] [get_bd_pins IMU_control_0/data_wi2c] [get_bd_pins ila_0/probe4]
  ...
  connect_bd_net -net IMU_control_0_rw_i2c [get_bd_pins I2C_master_0/rw] [get_bd_pins IMU_control_0/rw_i2c] [get_bd_pins ila_0/probe2]
  connect_bd_net -net IMU_control_0_we_bram [get_bd_pins IMU_control_0/we_bram] [get_bd_pins blk_mem_gen_0/wea]
  connect_bd_net -net IO_buffer_0_IOBUF_IO_O [get_bd_pins I2C_master_0/SDA_i] [get_bd_pins IO_buffer_0/IOBUF_IO_O] [get_bd_pins ila_0/probe0]
  connect_bd_net -net IO_buffer_1_IOBUF_IO_O [get_bd_pins I2C_master_0/SCL_i] [get_bd_pins IO_buffer_1/IOBUF_IO_O] [get_bd_pins ila_0/probe1]
  connect_bd_net -net Net2 [get_bd_ports IMU_I2C_SCL] [get_bd_pins IO_buffer_1/IOBUF_IO_IO]
  connect_bd_net -net Net3 [get_bd_ports IMU_I2C_SDA] [get_bd_pins IO_buffer_0/IOBUF_IO_IO]
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins I2C_master_0/clk] [get_bd_pins IMU_control_0/clk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins filtre_anti_rebond_0/clk] [get_bd_pins ila_0/clk] [get_bd_pins time_pulse_0/clk]
  connect_bd_net -net rst_n_0_1 [get_bd_pins I2C_master_0/rst_n] [get_bd_pins IMU_control_0/rst_n] [get_bd_pins filtre_anti_rebond_0/o_sign] [get_bd_pins time_pulse_0/rst_n]
  connect_bd_net -net rst_n_1 [get_bd_ports rst_n] [get_bd_pins filtre_anti_rebond_0/i_sign]
