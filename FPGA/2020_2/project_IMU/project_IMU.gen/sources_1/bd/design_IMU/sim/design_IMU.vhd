...
architecture STRUCTURE of design_IMU is
  ...
  component design_IMU_ila_0_0 is
  port (
    clk : in STD_LOGIC;
  ...
  end component design_IMU_ila_0_0;
  ...
  component design_IMU_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component design_IMU_xlconstant_0_0;
  component design_IMU_filtre_anti_rebond_0_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    i_sign : in STD_LOGIC;
  ...
  signal IMU_control_0_led : STD_LOGIC_VECTOR ( 3 downto 0 );
...
begin
  clk_0_1 <= clk;
  led(3 downto 0) <= IMU_control_0_led(3 downto 0);
  rst_n_1 <= rst_n;
...
filtre_anti_rebond_0: component design_IMU_filtre_anti_rebond_0_0
     port map (
      clk => clk_0_1,
      i_sign => rst_n_1,
      o_sign => rst_n_0_1,
      rst_n => xlconstant_0_dout(0)
    );
ila_0: component design_IMU_ila_0_0
     port map (
      clk => clk_0_1,
      probe0(0) => IO_buffer_0_IOBUF_IO_O,
      probe1(0) => IO_buffer_1_IOBUF_IO_O,
      probe2(0) => IMU_control_0_rw_i2c,
      probe3(6 downto 0) => IMU_control_0_addr_i2c(6 downto 0),
      probe4(7 downto 0) => IMU_control_0_data_wi2c(7 downto 0),
      probe5(7 downto 0) => I2C_master_0_data_rd(7 downto 0),
      probe6(0) => I2C_master_0_ack_err
    );
...
xlconstant_0: component design_IMU_xlconstant_0_0
     port map (
