...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_IMU_AXI is
  ...
  signal \data_nb133_out__3\ : STD_LOGIC;
  signal \data_nb135_out__1\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_6\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_7\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[2]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[2]_i_4\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[2]_i_6\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \acc_x[31]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \acc_y[31]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \addr_i2c[3]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \addr_i2c[6]_i_6\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \cpt_ms[2]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \cpt_ms[3]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \cpt_ms[4]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \cpt_ms[4]_i_8\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cpt_ms[4]_i_9\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_nb[0]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_nb[1]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_nb[2]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \data_wi2c[0]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_wi2c[3]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \data_wi2c[5]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_wi2c[6]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_wr[15]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of ena_i2c_i_3 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of ena_i2c_i_5 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of ena_i2c_i_6 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of ena_i2c_i_7 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of ena_i2c_i_8 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \mag_yL[0]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \mag_y[31]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \nb_r[2]_i_5\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \nb_r[2]_i_6\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \nb_r[2]_i_7\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \nb_r[2]_i_8\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \nb_r[2]_i_9\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of periph_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of rw_i2c_i_4 : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \vit_ang_z[31]_i_1\ : label is "soft_lutpair13";
begin
  AR(0) <= \^ar\(0);
...
\FSM_sequential_current_state[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"111F11111F1F1F1F"
    )
        port map (
      I0 => \data_nb135_out__1\,
...
\cpt_ms[4]_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"3FFFAA88C0000000"
    )
        port map (
      I0 => p_29_in,
      I1 => \cpt_ms_reg_n_0_[3]\,
      I2 => \cpt_ms[4]_i_9_n_0\,
...
ena_i2c_i_8: unisim.vcomponents.LUT5
    generic map(
      INIT => X"ECEEFFFF"
    )
        port map (
...
periph_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"04040000000000FF"
    )
        port map (
      I0 => \FSM_sequential_current_state[1]_i_4_n_0\,
      I1 => \data_nb135_out__1\,
      I2 => current_state(1),
      I3 => periph_i_3_n_0,
      I4 => current_state(0),
      I5 => current_state(2),
