...
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { pulse_1s }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { pulse_1ms }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports { pulse_1us }]; #IO_L11P_T1_SRCC_13 Sch=jb_p[2]
...
set_property PULLUP true [get_ports IMU_I2C_SDA]
set_property DRIVE 8 [get_ports IMU_I2C_SDA]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports IMU_I2C_SCL]
set_property PULLUP true [get_ports IMU_I2C_SCL]
set_property DRIVE 8 [get_ports IMU_I2C_SCL]
