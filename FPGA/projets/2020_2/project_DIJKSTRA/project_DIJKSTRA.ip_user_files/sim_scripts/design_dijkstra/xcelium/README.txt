...
#
# Generated by export_simulation on Tue Jun 07 09:57:01 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './design_dijkstra.sh' script.

./design_dijkstra.sh -reset_run
...
./design_dijkstra.sh -noclean_files

For more information on the script, please type './design_dijkstra.sh -help'.
