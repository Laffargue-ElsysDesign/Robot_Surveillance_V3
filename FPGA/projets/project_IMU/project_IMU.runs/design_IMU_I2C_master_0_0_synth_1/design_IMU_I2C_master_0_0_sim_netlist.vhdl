...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_I2C_master is
  ...
  attribute SOFT_HLUTNM of \bit_cnt[1]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \bit_cnt[2]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of busy_i_2 : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of data_clk_prev_i_1 : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \data_rd[7]_i_5\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of scl_ena_i_3 : label is "soft_lutpair20";
...
\bit_cnt[1]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"90"
    )
        port map (
