...
-- Command     : write_vhdl -force -mode funcsim -rename_top design_fpga_Dijkstra_reg_0_0 -prefix
--               design_fpga_Dijkstra_reg_0_0_ design_fpga_Dijkstra_reg_0_0_sim_netlist.vhdl
...
entity design_fpga_Dijkstra_reg_0_0_DIJKSTRA_CONTROLLER is
  port (
...
end design_fpga_Dijkstra_reg_0_0_DIJKSTRA_CONTROLLER;

architecture STRUCTURE of design_fpga_Dijkstra_reg_0_0_DIJKSTRA_CONTROLLER is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_fpga_Dijkstra_reg_0_0_NEAREST_NODE is
  port (
...
end design_fpga_Dijkstra_reg_0_0_NEAREST_NODE;

architecture STRUCTURE of design_fpga_Dijkstra_reg_0_0_NEAREST_NODE is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_fpga_Dijkstra_reg_0_0_ROM is
  port (
    Q : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
end design_fpga_Dijkstra_reg_0_0_ROM;

architecture STRUCTURE of design_fpga_Dijkstra_reg_0_0_ROM is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_fpga_Dijkstra_reg_0_0_UPDATE_RAM is
  port (
...
end design_fpga_Dijkstra_reg_0_0_UPDATE_RAM;

architecture STRUCTURE of design_fpga_Dijkstra_reg_0_0_UPDATE_RAM is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_fpga_Dijkstra_reg_0_0_comparateur1 is
  port (
...
end design_fpga_Dijkstra_reg_0_0_comparateur1;

architecture STRUCTURE of design_fpga_Dijkstra_reg_0_0_comparateur1 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_fpga_Dijkstra_reg_0_0_comparateur2 is
  port (
...
end design_fpga_Dijkstra_reg_0_0_comparateur2;

architecture STRUCTURE of design_fpga_Dijkstra_reg_0_0_comparateur2 is
begin
\comp_out_reg[0]\: unisim.vcomponents.FDCE
     port map (
      C => s00_axi_aclk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_fpga_Dijkstra_reg_0_0_dpram is
  port (
...
end design_fpga_Dijkstra_reg_0_0_dpram;

architecture STRUCTURE of design_fpga_Dijkstra_reg_0_0_dpram is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_fpga_Dijkstra_reg_0_0_TOP_dijkstra is
  port (
    D : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
end design_fpga_Dijkstra_reg_0_0_TOP_dijkstra;

architecture STRUCTURE of design_fpga_Dijkstra_reg_0_0_TOP_dijkstra is
...
begin
  p_0_in <= \^p_0_in\;
CONTROLLER: entity work.design_fpga_Dijkstra_reg_0_0_DIJKSTRA_CONTROLLER
     port map (
      AR(0) => \^p_0_in\,
      D(0) => CONTROLLER_n_4,
...
NEAREST_NODE_D: entity work.design_fpga_Dijkstra_reg_0_0_NEAREST_NODE
     port map (
      AR(0) => \^p_0_in\,
...
ROM_M: entity work.design_fpga_Dijkstra_reg_0_0_ROM
     port map (
...
UPDATE_RAM_D: entity work.design_fpga_Dijkstra_reg_0_0_UPDATE_RAM
     port map (
      AR(0) => \^p_0_in\,
      D(0) => UPDATE_RAM_D_n_41,
      E(0) => en_rom,
...
comparateur1_0: entity work.design_fpga_Dijkstra_reg_0_0_comparateur1
     port map (
      AR(0) => \^p_0_in\,
...
comparateur2_0: entity work.design_fpga_Dijkstra_reg_0_0_comparateur2
     port map (
      AR(0) => \^p_0_in\,
...
dpram_0: entity work.design_fpga_Dijkstra_reg_0_0_dpram
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_fpga_Dijkstra_reg_0_0_Dijkstra_reg_v1_0_S00_AXI is
  port (
...
end design_fpga_Dijkstra_reg_0_0_Dijkstra_reg_v1_0_S00_AXI;

architecture STRUCTURE of design_fpga_Dijkstra_reg_0_0_Dijkstra_reg_v1_0_S00_AXI is
...
DIJKSTRA: entity work.design_fpga_Dijkstra_reg_0_0_TOP_dijkstra
     port map (
      D(4) => DIJKSTRA_n_0,
      D(3) => DIJKSTRA_n_1,
      D(2) => DIJKSTRA_n_2,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_fpga_Dijkstra_reg_0_0_Dijkstra_reg_v1_0 is
  port (
...
end design_fpga_Dijkstra_reg_0_0_Dijkstra_reg_v1_0;

architecture STRUCTURE of design_fpga_Dijkstra_reg_0_0_Dijkstra_reg_v1_0 is
...
begin
  ...
  s00_axi_rvalid <= \^s00_axi_rvalid\;
Dijkstra_reg_v1_0_S00_AXI_inst: entity work.design_fpga_Dijkstra_reg_0_0_Dijkstra_reg_v1_0_S00_AXI
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_fpga_Dijkstra_reg_0_0 is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_fpga_Dijkstra_reg_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_fpga_Dijkstra_reg_0_0 : entity is "design_fpga_Dijkstra_reg_0_0,Dijkstra_reg_v1_0,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_fpga_Dijkstra_reg_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of design_fpga_Dijkstra_reg_0_0 : entity is "Dijkstra_reg_v1_0,Vivado 2020.2";
end design_fpga_Dijkstra_reg_0_0;

architecture STRUCTURE of design_fpga_Dijkstra_reg_0_0 is
...
U0: entity work.design_fpga_Dijkstra_reg_0_0_Dijkstra_reg_v1_0
     port map (
