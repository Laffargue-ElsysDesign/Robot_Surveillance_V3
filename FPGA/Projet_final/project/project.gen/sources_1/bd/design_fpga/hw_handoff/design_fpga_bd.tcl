...
################################################################
# This is a generated script based on design: design_fpga
#
...
proc create_root_design { parentCell } {
  ...
  set HOLO_UART [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 HOLO_UART ]
  ...
  # Create instance: IMU_v3_0, and set properties
  set IMU_v3_0 [ create_bd_cell -type ip -vlnv elsys-design.com:user:IMU_v3:1.0 IMU_v3_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Balise_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins Dijkstra_reg_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins Timer_ronde_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net Net [get_bd_ports IMU_I2C_SDA] [get_bd_pins IMU_v3_0/SDA_IO]
  connect_bd_net -net Net1 [get_bd_ports IMU_I2C_SCL] [get_bd_pins IMU_v3_0/SCL_IO]
  ...
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Dijkstra_reg_0/S00_AXI/S00_AXI_reg] -force
