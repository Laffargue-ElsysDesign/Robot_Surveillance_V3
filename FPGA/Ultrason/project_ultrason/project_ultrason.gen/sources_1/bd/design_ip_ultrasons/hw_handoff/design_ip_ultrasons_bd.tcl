...
################################################################
# This is a generated script based on design: design_ip_ultrasons
#
...
# source design_ip_ultrasons_script.tcl
...
set design_name design_ip_ultrasons
...
proc create_root_design { parentCell } {
  ...
  set sel_ult [ create_bd_port -dir O -from 2 -to 0 sel_ult ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Ultrasons_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Ultrasons_0_en_ult [get_bd_ports en_ult] [get_bd_pins Ultrasons_0/en_ult]
  connect_bd_net -net Ultrasons_0_sel_ult [get_bd_ports sel_ult] [get_bd_pins Ultrasons_0/sel_ult]
  connect_bd_net -net Ultrasons_0_trig_out [get_bd_ports trig_out] [get_bd_pins Ultrasons_0/trig_out]
  connect_bd_net -net echo_in_0_1 [get_bd_ports echo_in] [get_bd_pins Ultrasons_0/echo_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Ultrasons_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins time_pulse_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins Ultrasons_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins time_pulse_0/rst_n]
  connect_bd_net -net time_pulse_0_pulse_1ms [get_bd_pins Ultrasons_0/pulse_ms] [get_bd_pins time_pulse_0/pulse_1ms]
  connect_bd_net -net time_pulse_0_pulse_1us [get_bd_pins Ultrasons_0/pulse_us] [get_bd_pins time_pulse_0/pulse_1us]
  connect_bd_net -net xlconstant_0_dout [get_bd_ports out_1] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Ultrasons_0/S00_AXI/S00_AXI_reg] -force
