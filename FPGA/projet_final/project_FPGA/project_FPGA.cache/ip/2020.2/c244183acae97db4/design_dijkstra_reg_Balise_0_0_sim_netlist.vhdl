...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Balise_v1_0_S00_AXI is
  ...
  signal read : STD_LOGIC_VECTOR ( 4 to 4 );
  signal \read_reg_n_0_[0]\ : STD_LOGIC;
  signal \read_reg_n_0_[1]\ : STD_LOGIC;
  signal \read_reg_n_0_[2]\ : STD_LOGIC;
  signal \read_reg_n_0_[3]\ : STD_LOGIC;
...
\balise[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"4F"
    )
        port map (
