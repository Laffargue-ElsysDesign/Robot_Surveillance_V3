...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_DIJKSTRA_CONTROLLER is
  ...
  attribute SOFT_HLUTNM of en_ram_ext_INST_0_i_1 : label is "soft_lutpair1";
...
\FSM_onehot_current_state[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \FSM_onehot_current_state_reg[5]\(3),
...
en_ram_ext_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B3BFBFBF"
    )
        port map (
...
\memory_ram[16][4]_i_12\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000055555557"
        ...
        port map (
      I0 => \s_end_node_reg[4]_0\(10),
      I1 => \s_end_node_reg[4]_0\(8),
      I2 => \s_end_node_reg[4]_0\(9),
      I3 => \s_end_node_reg[4]_0\(7),
      I4 => \s_end_node_reg[4]_0\(6),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_NEAREST_NODE is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_current_state[6]_i_3\ : label is "soft_lutpair19";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \addr_ram_ext[1]_INST_0\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \addr_ram_ext[2]_INST_0\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of comp_i_1 : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \comp_out[0]_i_2__0\ : label is "soft_lutpair23";
  ...
  attribute SOFT_HLUTNM of \comp_out[8]_i_10\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \comp_out[8]_i_4\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \comp_out[8]_i_6\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \comp_out[8]_i_9\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \comp_out[9]_i_2\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \data_out_b[9]_i_13\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \data_out_b[9]_i_14\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of en_ram_ext_INST_0 : label is "soft_lutpair26";
  ...
  attribute SOFT_HLUTNM of \node_seen[1]_i_2\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \node_seen[6]_i_3\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \node_seen[7]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \node_seen[8]_i_2\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \s_next_node[0]_i_1\ : label is "soft_lutpair20";
...
\data_out_b[9]_i_13\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\data_out_b[9]_i_15\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF808080"
    )
        port map (
...
en_ram_ext_INST_0: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EFEE"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UPDATE_RAM is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_current_state[6]_i_5__0\ : label is "soft_lutpair48";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \data_rom[4]_i_15\ : label is "soft_lutpair48";
...
\FSM_sequential_current_state[0]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0001FFFF"
        ...
        port map (
      I0 => \FSM_sequential_current_state[0]_i_2\(5),
      I1 => \FSM_sequential_current_state[0]_i_2\(6),
      I2 => \FSM_sequential_current_state[0]_i_2\(8),
      I3 => \FSM_sequential_current_state[0]_i_2\(7),
      I4 => \FSM_sequential_current_state[0]_i_2\(9),
      O => \slv_reg0_reg[16]\
    );
...
CONTROLLER: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_DIJKSTRA_CONTROLLER
     port map (
      ...
      \FSM_onehot_current_state_reg[0]\(0) => CONTROLLER_n_17,
      \FSM_onehot_current_state_reg[1]\ => CONTROLLER_n_15,
      \FSM_onehot_current_state_reg[1]_0\ => \FSM_onehot_current_state_reg[1]\,
      \FSM_onehot_current_state_reg[1]_1\ => CONTROLLER_n_37,
      \FSM_onehot_current_state_reg[1]_2\ => CONTROLLER_n_38,
      \FSM_onehot_current_state_reg[1]_3\ => CONTROLLER_n_39,
      ...
      \FSM_sequential_current_state_reg[1]_1\ => CONTROLLER_n_16,
      ...
      busy_ram_ext_0 => CONTROLLER_n_14,
      ...
      \cpt_reg[1]\ => CONTROLLER_n_24,
      data0(4 downto 0) => data0(4 downto 0),
      \data_out_a_reg[8]\(3) => CONTROLLER_n_9,
      \data_out_a_reg[8]\(2) => CONTROLLER_n_10,
      \data_out_a_reg[8]\(1) => CONTROLLER_n_11,
      \data_out_a_reg[8]\(0) => CONTROLLER_n_12,
      ...
      \node_seen_reg[0]_0\ => NEAREST_NODE_D_n_60,
      \node_seen_reg[10]_0\ => NEAREST_NODE_D_n_63,
      ...
      \node_seen_reg[14]_1\ => NEAREST_NODE_D_n_64,
      \node_seen_reg[15]_0\ => NEAREST_NODE_D_n_61,
      \node_seen_reg[15]_1\ => NEAREST_NODE_D_n_53,
      \node_seen_reg[16]_0\ => CONTROLLER_n_23,
      \node_seen_reg[16]_1\ => CONTROLLER_n_28,
      \node_seen_reg[16]_2\ => NEAREST_NODE_D_n_59,
      \node_seen_reg[1]_0\ => NEAREST_NODE_D_n_48,
      \node_seen_reg[2]_0\ => NEAREST_NODE_D_n_49,
      \node_seen_reg[3]_0\ => NEAREST_NODE_D_n_50,
      \node_seen_reg[4]_0\ => NEAREST_NODE_D_n_51,
      \node_seen_reg[5]_0\ => NEAREST_NODE_D_n_52,
      ...
      \node_seen_reg[9]_0\ => NEAREST_NODE_D_n_65,
      \out\(2) => CONTROLLER_n_25,
      \out\(1) => CONTROLLER_n_26,
      \out\(0) => CONTROLLER_n_27,
...
NEAREST_NODE_D: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_NEAREST_NODE
     port map (
      D(9) => NEAREST_NODE_D_n_33,
      D(8) => NEAREST_NODE_D_n_34,
      D(7) => NEAREST_NODE_D_n_35,
      D(6) => NEAREST_NODE_D_n_36,
      D(5) => NEAREST_NODE_D_n_37,
      D(4) => NEAREST_NODE_D_n_38,
      D(3) => NEAREST_NODE_D_n_39,
      D(2) => NEAREST_NODE_D_n_40,
      D(1) => NEAREST_NODE_D_n_41,
      D(0) => NEAREST_NODE_D_n_42,
      ...
      \FSM_onehot_current_state_reg[3]_1\ => CONTROLLER_n_14,
      \FSM_onehot_current_state_reg[4]_0\ => CONTROLLER_n_23,
      ...
      \s_next_node_reg[0]_2\ => NEAREST_NODE_D_n_49,
      \s_next_node_reg[0]_3\ => NEAREST_NODE_D_n_50,
      \s_next_node_reg[0]_4\ => NEAREST_NODE_D_n_60,
      \s_next_node_reg[1]_0\ => NEAREST_NODE_D_n_26,
      \s_next_node_reg[1]_1\ => NEAREST_NODE_D_n_48,
      \s_next_node_reg[2]_0\ => NEAREST_NODE_D_n_25,
      \s_next_node_reg[2]_1\ => NEAREST_NODE_D_n_51,
      \s_next_node_reg[2]_2\ => NEAREST_NODE_D_n_52,
      \s_next_node_reg[2]_3\ => NEAREST_NODE_D_n_59,
      \s_next_node_reg[2]_4\ => NEAREST_NODE_D_n_61,
      \s_next_node_reg[2]_5\ => NEAREST_NODE_D_n_62,
      \s_next_node_reg[2]_6\ => NEAREST_NODE_D_n_63,
      \s_next_node_reg[2]_7\ => NEAREST_NODE_D_n_64,
      \s_next_node_reg[2]_8\ => NEAREST_NODE_D_n_65,
      \s_next_node_reg[3]_0\ => NEAREST_NODE_D_n_12,
      \s_next_node_reg[3]_1\ => NEAREST_NODE_D_n_53,
...
UPDATE_RAM_D: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UPDATE_RAM
     port map (
      D(0) => UPDATE_RAM_D_n_66,
      E(0) => en_rom,
      \FSM_onehot_current_state_reg[0]_0\(0) => CONTROLLER_n_17,
      \FSM_onehot_current_state_reg[1]_0\ => CONTROLLER_n_16,
      ...
      \FSM_onehot_current_state_reg[2]_1\ => CONTROLLER_n_24,
      ...
      \FSM_onehot_current_state_reg[6]_0\ => CONTROLLER_n_28,
      ...
      \data_rom[4]_i_6_0\(4) => CONTROLLER_n_40,
      \data_rom[4]_i_6_0\(3) => CONTROLLER_n_41,
      \data_rom[4]_i_6_0\(2) => CONTROLLER_n_42,
      \data_rom[4]_i_6_0\(1) => CONTROLLER_n_43,
      \data_rom[4]_i_6_0\(0) => CONTROLLER_n_44,
      ...
      \slv_reg0_reg[16]\ => UPDATE_RAM_D_n_304
    );
comparateur1_0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_comparateur1
     port map (
      ...
      \memory_ram[30][9]_i_3_0\ => CONTROLLER_n_13,
