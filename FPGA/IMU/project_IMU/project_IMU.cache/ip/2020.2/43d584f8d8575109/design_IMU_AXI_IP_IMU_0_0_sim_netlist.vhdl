...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_IMU_AXI is
  ...
  attribute SOFT_HLUTNM of \data_wi2c[3]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_wi2c[5]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_wi2c[5]_i_3\ : label is "soft_lutpair16";
...
\data_wi2c[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"000022F0"
    )
        port map (
...
\data_wi2c[5]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"47"
    )
        port map (
