...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_IMU_AXI is
  ...
  signal \data_wi2c[5]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_7\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[2]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[2]_i_4\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \acc_x[31]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \acc_y[31]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \addr_i2c[3]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \addr_i2c[6]_i_6\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \cpt_ms[2]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \cpt_ms[4]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \cpt_ms[4]_i_8\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \data_nb[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_nb[2]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \data_wi2c[3]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \data_wi2c[5]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \data_wi2c[5]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \data_wr[14]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \data_wr[15]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of ena_i2c_i_3 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of ena_i2c_i_5 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of ena_i2c_i_6 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of ena_i2c_i_7 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of ena_i2c_i_8 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \mag_yL[0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \mag_yL[1]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \mag_yL[2]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \mag_yL[3]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \mag_yL[4]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \mag_yL[5]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \mag_yL[6]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \mag_yL[7]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \mag_yL[7]_i_3\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \mag_y[31]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \nb_r[2]_i_5\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \nb_r[2]_i_6\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \nb_r[2]_i_7\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \nb_r[2]_i_8\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \nb_r[2]_i_9\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of periph_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of periph_i_3 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of rw_i2c_i_4 : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \vit_ang_z[31]_i_1\ : label is "soft_lutpair11";
begin
  AR(0) <= \^ar\(0);
...
\data_wi2c[5]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_IP_IMU_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of axi_awready0 : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of axi_rvalid_i_1 : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of axi_wready0 : label is "soft_lutpair23";
begin
