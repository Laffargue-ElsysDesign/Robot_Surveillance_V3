...
################################################################
# This is a generated script based on design: design_IMU_AXI
#
...
# source design_IMU_AXI_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# I2C_master, IO_buffer, IO_buffer, time_pulse
...
set design_name design_IMU_AXI
...
proc create_root_design { parentCell } {
  ...
  # Create instance: IP_IMU_0, and set properties
  set IP_IMU_0 [ create_bd_cell -type ip -vlnv elsys-design.com:user:IP_IMU:1.0 IP_IMU_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins IP_IMU_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net I2C_master_0_ack_err [get_bd_pins I2C_master_0/ack_err] [get_bd_pins IP_IMU_0/ack_err_i2c]
  connect_bd_net -net I2C_master_0_busy [get_bd_pins I2C_master_0/busy] [get_bd_pins IP_IMU_0/busy_i2c]
  connect_bd_net -net I2C_master_0_data_rd [get_bd_pins I2C_master_0/data_rd] [get_bd_pins IP_IMU_0/data_ri2c]
  connect_bd_net -net I2C_master_0_flag_data_ack [get_bd_pins I2C_master_0/flag_data_ack] [get_bd_pins IP_IMU_0/flag_data_i2c]
  ...
  connect_bd_net -net IP_IMU_0_addr_i2c [get_bd_pins I2C_master_0/addr] [get_bd_pins IP_IMU_0/addr_i2c]
  connect_bd_net -net IP_IMU_0_data_wi2c [get_bd_pins I2C_master_0/data_wr] [get_bd_pins IP_IMU_0/data_wi2c]
  connect_bd_net -net IP_IMU_0_ena_i2c [get_bd_pins I2C_master_0/ena] [get_bd_pins IP_IMU_0/ena_i2c]
  connect_bd_net -net IP_IMU_0_rw_i2c [get_bd_pins I2C_master_0/rw] [get_bd_pins IP_IMU_0/rw_i2c]
  connect_bd_net -net Net [get_bd_ports IMU_I2C_SDA] [get_bd_pins IO_buffer_0/IOBUF_IO_IO]
  connect_bd_net -net Net1 [get_bd_ports IMU_I2C_SCL] [get_bd_pins IO_buffer_1/IOBUF_IO_IO]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins I2C_master_0/clk] [get_bd_pins IP_IMU_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins time_pulse_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins I2C_master_0/rst_n] [get_bd_pins IP_IMU_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins time_pulse_0/rst_n]
  connect_bd_net -net time_pulse_0_pulse_1ms [get_bd_pins IP_IMU_0/pulse_1ms] [get_bd_pins time_pulse_0/pulse_1ms]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs IP_IMU_0/S00_AXI/S00_AXI_reg] -force
