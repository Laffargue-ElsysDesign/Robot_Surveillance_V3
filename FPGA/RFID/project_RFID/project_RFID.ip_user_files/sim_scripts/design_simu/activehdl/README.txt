...
#
# Generated by export_simulation on Thu Aug 18 13:37:57 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './design_simu.sh' script.

./design_simu.sh -reset_run
...
./design_simu.sh -noclean_files

For more information on the script, please type './design_simu.sh -help'.
