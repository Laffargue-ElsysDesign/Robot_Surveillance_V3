...
architecture STRUCTURE of design_RFID_UART_TX_0_0_UART_TX is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_r_SM_Main[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_onehot_r_SM_Main[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_onehot_r_SM_Main[4]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \r_Clk_Count[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \r_Clk_Count[10]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \r_Clk_Count[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \r_Clk_Count[3]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \r_Clk_Count[5]_i_2\ : label is "soft_lutpair5";
...
\FSM_onehot_r_SM_Main[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_onehot_r_SM_Main[3]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\r_Clk_Count[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
r_TX_Done_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
