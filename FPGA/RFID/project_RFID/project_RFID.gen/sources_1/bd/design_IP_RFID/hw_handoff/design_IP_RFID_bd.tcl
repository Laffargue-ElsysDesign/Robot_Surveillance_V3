...
################################################################
# This is a generated script based on design: design_IP_RFID
#
...
# source design_IP_RFID_script.tcl
...
set design_name design_IP_RFID
...
proc create_root_design { parentCell } {
  ...
  # Create instance: RFID_reader_0, and set properties
  set RFID_reader_0 [ create_bd_cell -type ip -vlnv elsys-design.com:user:RFID_reader:1.0 RFID_reader_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins RFID_reader_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net RFID_reader_0_TX_Serial [get_bd_ports RFID_UART_TX] [get_bd_pins RFID_reader_0/TX_Serial] [get_bd_pins ila_0/probe0]
  connect_bd_net -net RX_Serial_0_1 [get_bd_ports RFID_UART_RX] [get_bd_pins RFID_reader_0/RX_Serial] [get_bd_pins ila_0/probe1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins RFID_reader_0/s00_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins time_pulse_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins RFID_reader_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins time_pulse_0/rst_n]
  connect_bd_net -net time_pulse_0_pulse_1ms [get_bd_pins RFID_reader_0/pulse_ms] [get_bd_pins time_pulse_0/pulse_1ms]
  connect_bd_net -net time_pulse_0_pulse_1us [get_bd_pins RFID_reader_0/pulse_us] [get_bd_pins ila_0/probe2] [get_bd_pins time_pulse_0/pulse_1us]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RFID_reader_0/S00_AXI/S00_AXI_reg] -force
