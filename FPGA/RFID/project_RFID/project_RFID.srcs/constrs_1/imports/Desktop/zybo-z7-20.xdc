...
#set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS33 } [get_ports { Reg_DV }]; #IO_L18N_T2_13 Sch=led5_r
...
#set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { i_RX_Serial }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]		 
#set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { o_TX_Serial  }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]         
