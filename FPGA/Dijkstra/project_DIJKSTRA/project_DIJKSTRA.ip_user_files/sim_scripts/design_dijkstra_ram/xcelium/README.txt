...
#
# Generated by export_simulation on Tue Jun 14 11:49:05 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './design_dijkstra_ram.sh' script.

./design_dijkstra_ram.sh -reset_run
...
./design_dijkstra_ram.sh -noclean_files

For more information on the script, please type './design_dijkstra_ram.sh -help'.
